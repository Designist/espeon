...
<body>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
	...
	<div class="container">
		...
		<div class = "row">
			<div id="login-panel">
				<a href="https://login.live.com/oauth20_authorize.srf?client_id=000000004816F77B&scope=wl.signin&response_type=token&redirect_uri=http://espeon.azurewebsites.net" target="_blank">Login</a>
			</div>
